    ...
    <div class="form-group col-lg-13">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Tutup Uang Muka</li>
        </ol>
      </nav>
  <!-- header pengeluaran -->          
        <div class="form-group col-lg-4 ">
                  ...
                  <div class="panel-body">
                      ...
                      <?php
                           ...
                           echo form_open('master/simpanHeaderpengeluarantutup',$attributes); 
                      ...
                      <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                          ...
                          <div class="form-group col-lg-6">
                            <label for="txtiduangmuka">Uang Muka</label>
                            <input type="text" class="form-control" id="txtiduangmuka" name="txtiduangmuka" value="<?php echo $iduangmuka; ?>">
                        </div>
                          <div class="form-group col-lg-6">
                            <label>Bidang</label>
                          ...
                          <div class="form-group col-lg-12">
                              ...
                              <textarea class="form-control" rows="1" cols="20" name="txtketerangan" id="txtketerangan" placeholder="Masukan Keterangan Keperluan"><?php echo $ketkeperluan; ?></textarea>
                          </div>
                          
                          <div class="form-group col-lg-6">
                              <label for="txtnilai">Nilai Uang Muka</label>
                              <input type="text" class="form-control" id="txtnilai" name="txtnilai"  value="<?php echo $nilai; ?>">
                          </div>
                          <div class="form-group col-lg-6">
