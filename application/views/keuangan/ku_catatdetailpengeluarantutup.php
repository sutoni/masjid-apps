        ...
        <div class="form-group col-lg-4 ">
                  ...
                  <div class="panel-body">
                      ...
                      <?php
                           ...
                           echo form_open('master/simpanDetailpengeluarantutup',$attributes); 
                      ?>   
                   ...
                   <div class="form-group col-lg-11">
                     ...
                     <div class="card" style="width: 70rem;">
                      <div class="card-body">
                        ...
                        <p class="card-text">Jumlah Uang Muka : <?php echo "$nilai"; ?>.</p>
                      </div>
                    </div>
                          ...
                          <tbody>
                             <?php     
                              ...
                              <tr>  
                                    ...
                                    <td colspan="6">Total </td><td><?php echo $totalpengeluaran; ?></td><td colspan="3"></td>
                                </tr>     
                          </tbody>    
                      </table>
