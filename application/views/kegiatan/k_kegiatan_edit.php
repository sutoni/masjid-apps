                     ...
                     <?php
                      ...
                      <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); 
                          ...
                          foreach($data0 as $key){
                                        $idrealisasikegiatan = $key->idrealisasikegiatan;
                                        $namakegiatan = $key->namakegiatan;
                                        $tglkegiatan = $key->tglkegiatan;
                                        $tempatkegiatan = $key->tempatkegiatan;
                                        $waktukegiatan = $key->waktukegiatan;
                                        $agendakegiatan = $key->agendakegiatan;
                                        $idkegiatan =  $key->kodekegiatan;
                                        $ketua = $key->ketua;
                                        $pic = $key->pic;
                                        $loginput = $key->loginput;
                               ...
                               <option value="<?php echo $idkegiatan; ?>"><?php echo $namakegiatan; ?></option>
                                <?php 
                                    foreach($data1 as $key){
                                        $kodekegiatan = $key->kodekegiatan;
                                        $namakegiatan = $key->namakegiatan;
                                        ?>
                                            <option value="<?php echo $kodekegiatan; ?>"><?php echo $namakegiatan; ?></option>
                                        <?php   
                                    }
                      ...
                      <div class="form-group col-lg-6">
                        <label for="txttglkegiatan">Tanggal Kegiatan</label>
                              <div class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                                      ...
                                      <input class="form-control" type="text" name="txttglkegiatan" id="txttglkegiatan" value="<?php echo $tglkegiatan; ?>">                         
                              </div>
                      </div>
                      <div class="form-group col-lg-6">
                            <label for="txtwaktu">Waktu Kegiatan</label>
                            <input type="text" class="form-control"  id="txtwaktu" name="txtwaktu" value="<?php echo $waktukegiatan; ?>" >

                            <input type="hidden" class="form-control"  id="txtidkegiatan" name="txtidkegiatan" value="<?php echo $idrealisasikegiatan; ?>" >
                        </div>   
                      <div class="form-group col-lg-12">
                              <label for="txtagenda">Agenda Kegiatan</label>
                              <textarea class="form-control" rows="1" cols="20" name="txtagenda" id="txtagenda" ><?php echo $agendakegiatan; ?></textarea>
                          </div>
                       <div class="form-group col-lg-12">
                            <label for="txttempat">Tempat Kegiatan</label>
                            <input type="text" class="form-control"  id="txttempat" name="txttempat" value="<?php echo $tempatkegiatan; ?>" >
                        </div>    
                          
    
                          <div class="form-group col-lg-6">
                            <label for="txtketua">Ketua</label>
                            <input type="text" class="form-control" id="txtketua" name="txtketua" value="<?php echo $ketua; ?>">
                          </div> 
                          <div class="form-group col-lg-6">
                            <label for="txtpic">PIC</label>
                            <input type="text" class="form-control" id="txtpic" name="txtpic" value="<?php echo $pic; ?>">
                          </div> 
                                            ...
                                            <tr><td>$noa</td>
                                                ...
                                                <td>$baris->pic</td>
                                                 ...
                                                 echo "<td align='center'>   
                                                        <a href=\"".base_url()."kegiatan//".$baris->idrealisasikegiatan."\">
                                                        Edit</a>
                                                       </td> 
                                               ";
                                        echo"                                            </tr>     
