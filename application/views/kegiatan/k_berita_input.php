                      ...
                      <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                       ...
                       <div class="form-group col-lg-9">
                          ...
                          <div class="form-group col-lg-11">
                            ...
                            <input type="file" class="form-control" id="filefoto" name="filefoto" placeholder="Path folder gambar">
                        </div> 
                       

                          
                          <div class="form-group col-lg-12">
                              <button type="submit" class="btn btn-primary" id="btnDraft" name="btnDraft">Draft</button>
                              <button type="submit" class="btn btn-primary" id="btnPublish" name="btnPublish">Publish</button>
                          </div>
                  </div> 
                </div>
        </div>  
                                                ...
                                                <td>$baris->statusberita</td>
                                                 ...
                                                 echo "<td align='center'>";   
                                                      if($baris->statusberita =="draft"){
                                                        ...
                                                        Edit</a> |
                                                        <a href=\"".base_url()."kegiatan/publish/".$baris->idberita."\">
                                                        Publish</a> |
