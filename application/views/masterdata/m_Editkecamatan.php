...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel-body">
                    ...
                    <?php
                        ...
                        echo form_open('masterdata/updateKecamatan',$attributes); 
                        foreach($data as $key){
                            $kdkecamatan = $key->kdkecamatan;
                            $namakecamatan = $key->namakecamatan;
                            $kota = $key->kota;
                        }
                   ...
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control" id="txtkdkecamatan" name="txtkdkecamatan" value="<?php echo $kdkecamatan; ?>" readonly>
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamakecamatan">Nama Kecamatan</label>
                            <input type="text" class="form-control" id="txtnamakecamatan" name="txtnamakecamatan" value="<?php echo $namakecamatan; ?>">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="txtkota">Kota</label>
                            <input type="text" class="form-control" 
                               id="txtkota" name="txtkota" value="<?php echo $kota; ?>">
                        </div>
