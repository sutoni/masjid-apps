...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel-body">
                    ...
                    <?php
                                    ...
                                    echo form_open('master/simpanPengurus',$attributes); 
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        ...
                        <div class="form-group col-lg-12">
                            <label>Atasan Pengurus</label>
                             <select name="txtatasan" id="txtatasan" class="form-control">
                               <option value="">--Pilih Atasan Pengurus Organisasi--</option>
                              <?php 
                                    foreach($data as $key){
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control" rows="1" cols="20" name="txtketerangan" id="txtketerangan" placeholder="Keterangan tentang pengurus"></textarea>
                        </div>
