...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel panel-default">
                <div class="panel-body">
                    <h4>Input Kode Bidang</h4> 
                    <hr>   
                    <?php
                                    $attributes = array('role' => 'form', 'idbidang' => 'formadd');
                                    echo form_open('master/simpanKodebidang',$attributes); 
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control"
                                   id="txtnobidang" name="txtnobidang" disabled="">
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamabidang">Nama bidang</label>
                            <input type="text" class="form-control"                                id="txtnamabidang" name="txtnamabidang" placeholder="Masukan nama kode bidang">
                        </div>
