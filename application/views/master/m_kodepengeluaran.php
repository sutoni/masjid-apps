...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel panel-default">
                <div class="panel-body">
                    <h4>Input Kode Pengeluaran</h4> 
                    <hr>   
                    <?php
                                    $attributes = array('role' => 'form', 'idpengeluaran' => 'formadd');
                                    echo form_open('master/simpanKodepengeluaran',$attributes); 
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control"
                                   id="txtnopengeluaran" name="txtnopengeluaran" disabled="">
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamapengeluaran">Nama Pengeluaran</label>
                            <input type="text" class="form-control"                                id="txtnamapengeluaran" name="txtnamapengeluaran" placeholder="Masukan nama kode pengeluaran">
                        </div>
