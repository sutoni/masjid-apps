...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel panel-default">
                <div class="panel-body">
                    <h4>Edit Kode Pemasukan</h4> 
                    <hr>   
                    <?php
                                   $attributes = array('role' => 'form', 'kodepemasukan' => 'formadd');
                                    echo form_open('master/updateKodepemasukan',$attributes); 
                   ...
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control"
                                   id="txtnopemasukan" name="txtnopemasukan" value="<?php echo $idpemasukan; ?>">
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamapemasukan">Nama Pemasukan</label>
                            <input type="text" class="form-control" id="txtnamapemasukan" name="txtnamapemasukan" value="<?php echo $namapemasukan; ?>">
                        </div>
                       
                        
                        <div class="form-group col-lg-12">
                            <label for="txtketerangan">Keterangan</label>
                            <textarea class="form-control" rows="1" cols="20" name="txtketerangan" id="txtketerangan" placeholder="Keterangan tentang kode pemasukan"><?php echo $keterangan; ?></textarea>
                        </div>
