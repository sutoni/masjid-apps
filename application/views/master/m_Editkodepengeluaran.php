...
<div class="form-group col-lg-7  ">
                ...
                <div class="panel-body ">
                   <div class="form-group col-lg-10">
                      <h3>List Kode Pengeluaran</h3>
                      
                      <table id="example1" class="table table-bordered table-striped">
                          <thead>
                                <tr>
                                    <td>No </td><td > Kode Pengeluaran</td><td >Nama Pengeluaran</td><td>Keterangan</td><td>Tanggal Berlaku</td><td>Tanggal Berakhir</td><td> Action</td>
                                </tr>     
                          </thead>
                          <tbody>
                             <?php     
                                    ...
                                    foreach($data as $baris){
                                        ...
                                        echo"
                                            <tr><td>$noa</td>
                                                <td>$baris->kodepengeluaran</td>
                                                <td>$baris->namapengeluaran</td>
                                                ...
                                                <td>$baris->validto</td>
                                                 ...
                                                 echo "<td align='center'>   
                                                        <a href=\"".base_url()."master/m_Editkodepengeluaran/".$baris->kodepengeluaran."\">
                                                        Edit</a>
                                                       </td> 
                                               ";
                                        echo"                                            </tr>     
...
<div class="form-group col-lg-5 ">
                ...
                <div class="panel panel-default">
                <div class="panel-body">
                    <h4>Edit Kode Pengeluaran</h4> 
                    <hr>   
                    <?php
                                   $attributes = array('role' => 'form', 'kodepengeluaran' => 'formadd');
                                    echo form_open('master/updateKodepengeluaran',$attributes); 
                                    foreach($data3 as $key){
                                        $pengeluaran = $key->kodepengeluaran;
                   ...
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        ...
                        <div class="form-group col-lg-12">
                            <label for="txtnopengeluaran">No Kode pengeluaran</label>
                            <input type="text" class="form-control"
                                   id="txtnopengeluaran" name="txtnopengeluaran" value="<?php echo $pengeluaran; ?>">
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamapengeluaran">Nama pengeluaran</label>
                            <input type="text" class="form-control" id="txtnamapengeluaran" name="txtnamapengeluaran" value="<?php echo $namapengeluaran; ?>">
                        </div>
                       
                        
                        <div class="form-group col-lg-12">
                            <label for="txtketerangan">Keterangan</label>
                            <textarea class="form-control" rows="1" cols="20" name="txtketerangan" id="txtketerangan" placeholder="Keterangan tentang kode pengeluaran"><?php echo $keterangan; ?></textarea>
                        </div>
