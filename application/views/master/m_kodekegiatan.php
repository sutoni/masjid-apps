...
<div class="form-group col-lg-4 ">
                ...
                <div class="panel panel-default">
                <div class="panel-body">
                    <h4>Input Kode Kegiatan</h4> 
                    <hr>   
                    <?php
                                    $attributes = array('role' => 'form', 'idkegiatan' => 'formadd');
                                    echo form_open('master/simpanKodekegiatan',$attributes); 
                   ?>   <?php echo validation_errors('<div class="alert alert-danger col-md-12"><button class="close" data-dismiss="alert" type="button">×</button>','</div>'); ?>
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" class="form-control"
                                   id="txtnokegiatan" name="txtnokegiatan" disabled="">
                        </div>
                                        
                        <div class="form-group col-lg-12">
                            <label for="txtnamakegiatan">Nama kegiatan</label>
                            <input type="text" class="form-control"                                id="txtnamakegiatan" name="txtnamakegiatan" placeholder="Masukan nama kode kegiatan">
                        </div>
